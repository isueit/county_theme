 ...
 */
function county_theme_form_system_theme_settings_alter(&$form, &$form_state) {

  // Create a section for ISU theme settings
  $form['county_theme_settings'] = array(
    '#type'         => 'details',
  ...
  $form['county_theme_settings']['isu_navbar'] = array(
    '#type'         => 'checkbox',
  ...
  $form['county_theme_settings']['gold_border_hidden'] = array(
    '#type'         => 'checkbox',
  ...
  $form['iastate_footer_logo']['settings']['iastate_footer_logo_path'] = array(
    ...
    '#description' => t('Examples: logo.svg (for a file in the public filesystem), public://logo.svg, or themes/contrib/county_theme/logo.svg.'),
	// Tenery checks to see if 'use defaults' checkbox is enabled, if so we use a default if not take user input
	// Value is also reflected in respective theme setting field
    '#default_value'  => theme_get_setting('default_footer_logo') ? 'themes/custom/county_theme/images/wordmark-stacked.svg' : theme_get_setting('iastate_footer_logo_path'),
    ); 
